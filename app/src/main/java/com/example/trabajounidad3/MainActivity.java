...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Plato> platosIniciales;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        platosIniciales  = new ArrayList<>(Arrays.asList(
                new Plato(R.drawable.empanada_gallega, "", "Empanada rellena de atún y tomate", "Gluten, Pescado", 0),
                new Plato(R.drawable.empanada_gallega, "Tortilla Española", "", "", 0),
        ...
        // Guardar el precio original de cada plato y validarlo
        carta = new ArrayList<>();
        for (Plato plato : platosIniciales) {
            if (plato.esValido()) {
        ...
        Log.i(TAG, "Número de platos válidos: " + carta.size());
    ...
    //Método para validar los platos antes de añadirlos
    private void añadirPlato(Plato plato) {
        if (plato.esValido()) {
            carta.add(plato);
            Log.i(TAG, "Plato añadido: " + plato.getNombre());
        } else {
            Log.w(TAG, "Plato inválido: " + plato.getNombre());
        }
    }
